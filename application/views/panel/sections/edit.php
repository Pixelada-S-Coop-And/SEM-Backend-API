<h1 class="display-5">Editar sección</h1>
<hr />
        ...
        <div class="row"> 
            <div class="col-lg-4 col-md-12">    
                ...
                <div id="field-name" class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control required" value="<?php echo $section['name']; ?>" placeholder=""/>
                </div>

                <div id="field-description" class="form-group">
                    <label for="description">Descripción</label>
                    <textarea id="description" name="description" class="form-control"><?php echo $section['description']; ?></textarea>
                </div>
